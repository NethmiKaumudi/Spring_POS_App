...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds, JpaVendorAdapter vad){
        //This is the spring data JPA main object which handles all features
        ...
        factory.setPackagesToScan("lk.ijse.spring.entity");//set  entity records to the spring data JPA
        return factory;
    }
